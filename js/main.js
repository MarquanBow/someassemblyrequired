...
const galleryData = [
  {
    ...
    category: "functional",
    image: null,
    alt: "A geometric low-poly planter printed in forest green PLA+",
    material: "PLA+",
    printer: "Bambu Lab X1 Carbon",
    settings: "0.2mm layer height · 20% gyroid infill · 3 perimeters",
    description: "A parametric low-poly planter designed for small succulents. The key challenge was keeping the interlocking facets watertight while preserving the sharp angular aesthetic. Printed in Overture Matte Forest Green PLA+.",
  ...
  },
  {
    ...
    category: "artistic",
    image: null,
    alt: "A detailed articulated dragon figure with 42 independently moving joints",
    material: "PLA (dual-color)",
    printer: "Bambu Lab X1 Carbon",
    settings: "0.12mm layer height · 15% infill · PVA support interface",
    description: "A fully articulated dragon with 42 independently moving joints, printed in place with no assembly required. Dual-color achieved with a mid-print filament swap. The tight clearances required meticulous first-layer calibration so every joint moves freely.",
  ...
  },
  {
    ...
    category: "functional",
    image: null,
    alt: "A set of stackable cable management clips made in PETG",
    material: "PETG",
    printer: "Bambu Lab X1 Carbon",
    settings: "0.2mm layer height · 40% infill · 4 perimeters",
    description: "Parametric clips that snap onto any desk edge 10–30mm thick. PETG was selected for its flex-without-breaking behavior and resistance to the temperature swings common around desktop electronics.",
  ...
  },
  {
    ...
    material: "ABS-Like Resin (Matte Black)",
    printer: "Elegoo Saturn 3 Ultra",
    settings: "0.05mm layer height · UV wash 90s × 2",
    description: "A minimal desk phone stand optimized for a 15° eye-level viewing angle during video calls. The wide weighted base prevents tipping even with the heaviest cased phones. Resin was chosen for the silky surface finish that would require hours of sanding to achieve in FDM.",
  ...
  },
  {
    ...
    description: "A motor mount prototype for a custom fixed-wing RC build. ASA's UV stability and temperature resistance made it the clear choice over ABS for outdoor use. Three iterations were needed to optimize wall angles for maximum layer adhesion under vibration load.",
